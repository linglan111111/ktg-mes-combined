...
@Api("产品入库明细")
@RestController
@RequestMapping("/mobile/wm/productrecptdetail")
public class WmProductRecptDetailMobController extends BaseController {
    @Autowired
    ...
    @GetMapping("/list")
    public AjaxResult list(WmProductRecptDetail wmProductRecptDetail)
    {
