...
@Api("转移调拨明细")
@RestController
@RequestMapping("/mobile/wm/transferdetail")
public class WmTransferDetailMobController extends BaseController {
    @Autowired
    ...
    @GetMapping("/list")
    public AjaxResult list(WmTransferDetail wmTransferDetail)
    {
