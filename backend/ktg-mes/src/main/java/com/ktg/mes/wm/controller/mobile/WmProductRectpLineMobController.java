...
public class WmProductRectpLineMobController extends BaseController {
    ...
    {
        startPage();
        List<WmProductRecptLine> list = wmProductRecptLineService.selectWmProductRecptLineWithQuantityList(wmProductRecptLine);
    ...
    {
        return AjaxResult.success(wmProductRecptLineService.selectWmProductRecptLineWithQuantityByLineId(lineId));
    }
