...
public class WmTransferLineMobController extends BaseController {
    ...
    {
        startPage();
        List<WmTransferLine> list = wmTransferLineService.selectWmTransferLineWithQuantityList(wmTransferLine);
    ...
    {
        return AjaxResult.success(wmTransferLineService.selectWmTransferLineWithQuantityByLineId(lineId));
    }
