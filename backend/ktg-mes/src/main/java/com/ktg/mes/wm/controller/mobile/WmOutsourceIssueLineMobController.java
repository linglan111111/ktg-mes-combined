...
@RestController
@RequestMapping("/mobile/wm/outsourceissueline")
public class WmOutsourceIssueLineMobController extends BaseController {
    ...
    {
        startPage();
        List<WmOutsourceIssueLine> list = wmOutsourceIssueLineService.selectWmOutsourceIssueLineWithQuantityList(wmOutsourceIssueLine);
    ...
    {
        return AjaxResult.success(wmOutsourceIssueLineService.selectWmOutsourceIssueLineWithQuantityByLineId(lineId));
    }
