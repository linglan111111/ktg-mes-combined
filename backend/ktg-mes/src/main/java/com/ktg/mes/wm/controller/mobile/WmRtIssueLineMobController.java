...
public class WmRtIssueLineMobController extends BaseController {
    ...
    {
        startPage();
        List<WmRtIssueLine> list = wmRtIssueLineService.selectWmRtIssueLineWithQuantityList(wmRtIssueLine);
    ...
    {
        return AjaxResult.success(wmRtIssueLineService.selectWmRtIssueLineWithQuantityByLineId(lineId));
    }
